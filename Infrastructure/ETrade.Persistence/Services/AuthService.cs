...
using ETrade.Application.DTOs.Facebook;
    ...
    IMailService mailService) : IAuthService
{
    ...
    readonly UserManager<Domain.Entities.Identity.AppUser> _userManager = userManager;
    readonly ITokenHandler _tokenHandler = tokenHandler;
    readonly SignInManager<Domain.Entities.Identity.AppUser> _signInManager = signInManager;
